$(function () {
  ...
  function setup() {
    ...
    createPlatform(400, 300, 200, 20); // short but wide platform located 500 pixels from the left of the screen and 300 pixels from the middleof the screen
    ...
    createCannon("left", 100, 1000); // cannon on left wall, 600px down, shooting twice per second
    createCannon("right", 600, 1000); // cannon on right wall, 600px down, shooting twice per second
    createCannon("right", 300,1000);  // cannon on right wall, 300px down shooting once per second
